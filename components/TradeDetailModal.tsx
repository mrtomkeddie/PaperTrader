      ...
      <div className="bg-[#1C1C1E]/90 backdrop-blur-xl w-full max-w-sm rounded-[28px] border border-white/10 shadow-2xl relative z-10 animate-fade-in-up max-h-[85vh] flex flex-col">
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="text-center">
             <span className="text-xs font-semibold uppercase tracking-wider text-ios-gray block mb-1">Realized Net Result</span>
             <span className={`text-4xl font-bold tabular-nums tracking-tight ${trade.pnl >= 0 ? 'text-ios-green' : 'text-ios-red'}`}>
